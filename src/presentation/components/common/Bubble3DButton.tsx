...
export function Bubble3DButton({
  ...
  const handlePressOut = () => {
    ...
    // Pulsation façon gélatine : léger dépassement au-dessus de 1 avant de
    // se stabiliser, pour un vrai effet "vivant" au relâchement.
    scale.value = withSpring(1.06, { damping: 5, stiffness: 300, mass: 0.5 }, () => {
