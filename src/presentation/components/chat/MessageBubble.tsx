...
function lighten(hex: string, amount: number): string {
  ...
  // Préserve le canal alpha (2 derniers chiffres) s'il est présent, pour que
  // les deux extrémités du dégradé gardent la même transparence.
  const alpha = n.length >= 8 ? n.substring(6, 8) : '';
