                  ...
                  if (_sent)
                    Container(
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
                        ...
                        border: Border.all(color: AppColors.greenFlag.withValues(alpha: 0.5))),
                      child: Column(children: [
                        ...
                        Text('Vérifiez votre boîte mail et suivez le lien pour réinitialiser votre mot de passe.',
                          textAlign: TextAlign.center, style: TextStyle(color: AppColors.textPrimary.withValues(alpha: 0.8), fontSize: 14, height: 1.5)),
                      ...
                      child: Form(
                        ...
                        child: Column(children: [
                          ...
                          Text('Entrez votre adresse email et nous vous enverrons un lien de réinitialisation.',
                            textAlign: TextAlign.center, style: TextStyle(color: AppColors.textPrimary.withValues(alpha: 0.6), fontSize: 13, height: 1.4)),
                          const SizedBox(height: 24),
