 ...
 * Partage de position (en direct, arrière-plan, avec consentement des deux côtés).
      ...
      >
        ...
        <View style={styles.headerWrapper}>
          <View style={styles.headerRow}>
            <PulseTouchable onPress={() => router.back()} style={styles.backButton} accessibilityLabel="Retour">
            ...
            <PulseTouchable
              style={[styles.headerActionButton, styles.headerAiButton]}
              onPress={() => setAskModalVisible(true)}
              accessibilityLabel="Poser une question à l'IA"
            >
              <Ionicons name="sparkles" size={20} color="#FFFFFF" />
            </PulseTouchable>
            <PulseTouchable style={styles.headerActionButton} onPress={() => setTempModalVisible(true)} accessibilityLabel="Température de la conversation">
              <Ionicons name="thermometer-outline" size={22} color={colors.textPrimary} />
            </PulseTouchable>
            <PulseTouchable style={styles.headerActionButton} onPress={() => router.push(`/(app)/analysis/${conversationId}`)} accessibilityLabel="Analyse de la conversation">
