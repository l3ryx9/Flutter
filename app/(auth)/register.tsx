...
export default function RegisterScreen() {
  ...
  const setPendingRegistration = usePendingRegistrationStore((s) => s.setPending);
  ...
  const onSubmit = (data: RegisterFormData) => {
    // L'inscription elle-même n'a pas encore lieu ici : le formulaire est
    // valide, mais le compte n'est créé qu'après acceptation explicite du
    // consentement sur l'écran dédié qui suit (voir consent.tsx).
    setPendingRegistration({ data, antiBot: { honeypot, formOpenedAt } });
        ...
        <Animated.View entering={FadeInUp.delay(200)} style={styles.form}>
          ...
          */}
          ...
          <Text style={styles.terms}>
            ...
            et les conditions détaillées ci-dessus concernant l'analyse de vos
            conversations.
          </Text>
        </Animated.View>
